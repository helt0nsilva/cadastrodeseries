...
namespace ListaSeries
{
    class Program
    {
        ...
        private static void InserirSerie()
		{
			...
			Console.Write("Escolha o gênero da Série entre as opções acima: ");
			int entradaGenero = int.Parse(Console.ReadLine());

			Console.Write("Escreva o Título da Série: ");
			string entradaTitulo = Console.ReadLine();

			Console.Write("Escreva o Ano de Início da Série: ");
			int entradaAno = int.Parse(Console.ReadLine());

			Console.Write("Escreva uma Descrição da Série: ");
			string entradaDescricao = Console.ReadLine();
		...
		{
			Console.WriteLine();
			Console.WriteLine("Lista Séries - Programa de Cadastramento de Séries");
